...
if __name__ == "__main__":
    ...
    while(ok):
        ...
        if times == 0:
            print("Informe o usuario que deseja pegar os seguidores 1: ")
            user_f1 = str(input())
            user_id1 = getIdByUsername(api, user_f1)
            print("Informe o usuario que deseja pegar os seguidores 2: ")
            user_f2 = str(input())
            user_id2 = getIdByUsername(api, user_f2)
        ...
        text = ""
        if(user_swap == 0):
            followers2 = getTotalFollowers(api, user_id1)
            user_f = user_f1
        else:
            followers2 = getTotalFollowers(api, user_id2)
            user_f = user_f2
